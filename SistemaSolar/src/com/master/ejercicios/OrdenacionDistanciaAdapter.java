...
public class OrdenacionDistanciaAdapter extends ArrayAdapter<String> {

	private final Context contexto;
	private final String[] planetas;

	// Constructor
	public OrdenacionDistanciaAdapter(Context contexto, String[] planetas) {
	...
	public View getView(int posicion, View v, ViewGroup parent) {
		...
		imageView = utilidades.ordenaDistanciaImagenInicial(imageView, planeta,
				posicion);
