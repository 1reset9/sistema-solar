...
public class SistemaSolarSolFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getSolIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(R.array.sol_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.sol_id_fotos_creditos);
