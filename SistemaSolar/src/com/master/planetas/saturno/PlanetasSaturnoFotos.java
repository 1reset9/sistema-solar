...
public class PlanetasSaturnoFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getSaturnoIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(
				R.array.saturno_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.saturno_id_fotos_creditos);
