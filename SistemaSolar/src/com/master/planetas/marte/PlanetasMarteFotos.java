...
import com.master.R;
import com.master.planetas.marte.PlanetasMarteFotos.ImageAdapter;
import com.master.utilidades.ArraysIdImagenes;
import com.master.utilidades.Utilidades;

public class PlanetasMarteFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getMarteIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(R.array.marte_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.marte_id_fotos_creditos);
