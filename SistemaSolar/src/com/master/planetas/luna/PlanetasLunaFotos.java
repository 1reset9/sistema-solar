...
import com.master.R;
import com.master.planetas.luna.PlanetasLunaFotos.ImageAdapter;
import com.master.utilidades.ArraysIdImagenes;
import com.master.utilidades.Utilidades;

public class PlanetasLunaFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getLunaIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(R.array.luna_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.luna_id_fotos_creditos);
