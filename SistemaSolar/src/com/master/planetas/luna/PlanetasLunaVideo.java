...
import com.master.R;
import com.master.planetas.luna.PlanetasLunaVerVideo;

public class PlanetasLunaVideo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.planetas_luna_video);
	...
	protected void lanzarVideo() {
		Intent i = new Intent(this, PlanetasLunaVerVideo.class);
		startActivity(i);
	}
