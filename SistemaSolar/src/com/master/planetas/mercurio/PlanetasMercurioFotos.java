...
public class PlanetasMercurioFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getMercurioIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(
				R.array.mercurio_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.mercurio_id_fotos_creditos);
