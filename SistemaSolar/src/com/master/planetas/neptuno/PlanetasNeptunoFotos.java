...
public class PlanetasNeptunoFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getNeptunoIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(
				R.array.neptuno_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.neptuno_id_fotos_creditos);
