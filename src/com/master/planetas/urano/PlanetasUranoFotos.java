...
public class PlanetasUranoFotos extends Activity implements ViewFactory{
	
	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes= new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getUranoIdImagenes();
    private String[] idTextos;
    private String[] idCreditos;
    // este componente permite cierta animación para que aparezcan y desaparezcan las imágenes
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        idTextos = getResources().getStringArray(R.array.urano_id_fotos_textos);
        idCreditos = getResources().getStringArray(R.array.urano_id_fotos_creditos);
    	...
    	// se pone una animación para que entren por la izquierda y salgan por la derecha
    ...
    // para volver a la pantalla de planetas al pinchar el botón atrás del dispositivo
	@Override
