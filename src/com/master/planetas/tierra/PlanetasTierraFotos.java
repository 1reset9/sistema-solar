...
public class PlanetasTierraFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getTierraIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources()
				.getStringArray(R.array.tierra_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.tierra_id_fotos_creditos);
