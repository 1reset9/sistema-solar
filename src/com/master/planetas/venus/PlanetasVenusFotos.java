...
public class PlanetasVenusFotos extends Activity implements ViewFactory {

	Utilidades utilidades = new Utilidades();
	ArraysIdImagenes arraysIdImagenes = new ArraysIdImagenes();

	private Integer[] idImagenes = arraysIdImagenes.getVenusIdImagenes();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idTextos = getResources().getStringArray(R.array.venus_id_fotos_textos);
		idCreditos = getResources().getStringArray(
				R.array.venus_id_fotos_creditos);
